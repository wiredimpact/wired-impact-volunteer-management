...
class WI_Volunteer_Management_Admin {
	...
	public function show_getting_started_notice(){
		...
		if( $show_notice == true ){
			...
			$message = sprintf( __( 'We\'re excited for you to try Wired Impact Volunteer Management. <a href="%s">Learn how to get started.</a>', 'wired-impact-volunteer-management' ), admin_url( 'admin.php?page=wi-volunteer-management-help-settings' ) );
